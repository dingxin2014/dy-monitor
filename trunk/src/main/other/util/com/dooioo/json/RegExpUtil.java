...
/***********************************************************************************************************************
 * 提供对常用数据的合法性验证，目前能验证的有： email： isEmail 身份证： isIdentity 邮编： isZip 整数：isInt 浮点数：isFloat 数字：isNumber 日期：isDate
 * 手机号码：isMobile 空或者null：isNull
 * 
 * @author liguohui
 */
public class RegExpUtil {

	private static final String[] dfs = new String[] { "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy-MM-dd" };
	...
	private static final String REG_DATE =
	...
	private static final String IDENTITY_AREA =
			"11:北京,12:天津,13:河北,14:山西,15:内蒙古,21:辽宁,22:吉林,23:黑龙江,31:上海,32:江苏,33:浙江,34:安徽,35:福建,36:江西, 37:山东,41:河南,42:湖北,43:湖南,44:广东,45:广西,46:海南,50:重庆,51:四川,52:贵州,53:云南,54:西藏,61:陕西,62:甘肃,63:青海,64:宁夏,65:新疆,71:台湾,81:香港,82:澳门, 91:国外";

	private static final String REG_CHARACTER = "^[a-zA-Z0-9\\-\\_]+$";

	public static final String LICENSE_NUMBER_REG =
			"^[\u4e00-\u9fa5][A-Z](([0-9A-Z]{5})|([0-9A-Z]{4,5}[\u4e00-\u9fa5]))$";
	...
	public static boolean isNull(Object value) {
		return value == null || JSONNull.getInstance().equals(value) || "".equals(value.toString().trim());
	}
	 ...
	 * 
	 * @param value 将被验证的数字
	 * @param scale 要求的精度，如果精度小于或者等于0，将会抛出RuntimeException异常
	 * @return
	 */
